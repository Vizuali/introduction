 ...
 * This sketch is a simple homage that re-interprets live image as ASCII text.
...
//  // This the default image input, see the GettingStartedCapture 
//  // example if it creates an error
//  image = loadImage("lincoln.jpg");
...
//  // current characters for each position in the image
...
//  float hgap = width / float(image.width);
//  float vgap = height / float(image.height);
...
//      int pixelColor = image.pixels[index];
...
//      set(0, height - image.height, image);
//    }
//  //noLoop();
//}
